<?php
/**
 * MetaBox class, adds instances of custom boxes
 */
class Ob_MetaBox {
	...
	public function create_meta_box() {
		add_meta_box( $this->id, $this->label, array( $this, 'metabox_html' ), array( 'student' ) );
	}
	...
	public function save_metabox( $post_id ) {
		if ( isset( $_POST[ $this->field_name ] ) ) {
			$meta_value = sanitize_text_field( wp_unslash( $_POST[ $this->field_name ] ) );
